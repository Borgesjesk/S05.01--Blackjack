...
public class RenamePlayerUseCase {

    private final GameRepository gameRepository;

    public RenamePlayerUseCase(GameRepository gameRepository) {
        this.gameRepository = gameRepository;
    }

    public GameResponseDTO execute(String gameId, String newName) {
        Game game = gameRepository.findById(gameId)
                .orElseThrow(() -> new GameNotFoundException(gameId));
        game.renamePlayer(newName);
